...
(
    MAIN_MENU,
    SETUP_COMPANY_NAME, SETUP_COMPANY_ADDRESS, SETUP_COMPANY_EMAIL,
    SETUP_COMPANY_PHONE, SETUP_COMPANY_WEBSITE, SETUP_COMPANY_TAX_ID,
    INV_CLIENT_NAME, INV_CLIENT_ADDRESS, INV_CLIENT_EMAIL,
    INV_CLIENT_PHONE, INV_NUMBER, INV_DATE, INV_DUE_DATE,
    INV_CURRENCY, INV_PAGE_SIZE, INV_TAX_RATE, INV_DISCOUNT,
